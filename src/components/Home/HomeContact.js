...
const Message = () => (
  <FlashMessage duration={500000}>
    <div style={{ color: "green", fontSize: "1rem", fontWeight: "bold" }}>
      Wiadomość wysłana!
    </div>
    <div style={{ color: "green", fontSize: "1rem", fontWeight: "bold" }}>
...
const HomeContact = (props) => {
  ...
  const validate = () => {
    ...
    if (
      ...
      message.length <= 120 ||
      message.length > 200 ||
      !message.match(letters)
    ) {
      validationErrors.push(
        "Dodaj wiadomość składającą się z min. 120 znaków i maksymalnie 200!"
      );
  ...
  return (
    <section
      id="section4"
      className="contact_us info-section-5 container"
      style={{ height: "800px" }}
    >
      <div className="row">
                ...
                <fieldset>
                  <form onSubmit={handleSubmit} className="form_flex">
                    ...
                    <textarea
                      ...
                      rows="10"
                      cols="40"
                      placeholder="Gumbo beet greens corn soko endive gumbo gourd. Parsley shallot courgette tatsoi pea sprouts fava bean collard greens dandelion okra wakame tomato. Dandelion cucumber earthnut pea peanut soko zucchini."
                    />
      ...
      <footer className="footerElements">
        <div className="ender_container">
          <div className="ender">
            Copyright by <span>Magdalena Buzikiewicz</span>
          </div>
        </div>
