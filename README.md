The concept of Give-away project is to give user basic overview of app (landing page) and after registration/logging in (Firebase database) access to multi step form.
